...
router.patch('/api/adverts/update/:id', authenticateToken, advertController.patchAdvert);
router.post('/api/create-advert', authenticateToken, image, advertController.newAdvert);
...
router.get('/api/recent-advert', advertController.getMostRecent);
